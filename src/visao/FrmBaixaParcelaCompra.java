...
import controle.ControleBaixaParcelaCompra;
 ...
 * @author cyro
 */
public class FrmBaixaParcelaCompra extends javax.swing.JFrame {
    ConectaBanco conecta = new ConectaBanco();
    ConectaBanco c = new ConectaBanco();
    ModeloBaixaParcelaCompra mod = new ModeloBaixaParcelaCompra();
    ControleBaixaParcelaCompra control = new ControleBaixaParcelaCompra();
    ...
    String cliente, valorPagoI;
    Date dataVencimento;
    public FrmBaixaParcelaCompra(int cod) {
        initComponents();
        setIcon();
        valorAction();
        pagarAction();
        ...
        conecta.executaSQL("select * from parcela_compra inner join fornecedor on parcela_compra.id_fornecedor = fornecedor.id_fornecedor where id_parc_compra="+cod);
        jLabelCodigo.setText(String.valueOf(cod));
        try {
            conecta.rs.first();
            
            codCliente = conecta.rs.getInt("id_fornecedor");
            cod_venda = conecta.rs.getInt("cod_compra");
            valor_parcela = conecta.rs.getFloat("valor_parc");            
            valor_parcial = conecta.rs.getFloat("valor_parcial");
            dataVencimento = conecta.rs.getDate("datavenc");
            valorRestante = valor_parcela - valor_parcial;
            cliente = conecta.rs.getString("nome_fornecedor");
            jTextFieldCodigoP.setText(String.valueOf(cod));
            jTextFieldNome.setText(cliente);
            ...
            jTextFieldValorParcial.setText(String.valueOf(valor_parcial).replace(".", ","));
            
            jTextFieldValorRestante.setText(String.valueOf(df.format(valorRestante).replace(".", ",")));
            jTextFieldData.setText(String.valueOf(sdf.format(dataVencimento)));

        } catch (SQLException ex) {
            Logger.getLogger(FrmBaixaParcelaCompra.class.getName()).log(Level.SEVERE, null, ex);
        }finally{
    ...
    private void initComponents() {
        ...
        jTextFieldValorParcial = new javax.swing.JTextField();
        ...
        jButtonPagar.setText("Efetuar Pagamento (F12)");
        ...
        jTextFieldValorParcela.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        jButtonValorPago.setText("Valor a Ser Pago (F10)");
        ...
        jTextFieldPagoInput.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        jTextFieldValorParcial.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jTextFieldValorParcial.setForeground(new java.awt.Color(51, 51, 51));
        jTextFieldValorParcial.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 10, true));
        jTextFieldValorParcial.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                jTextFieldValorParcialMousePressed(evt);
            }
        });
        ...
        jTextFieldValorRestante.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jTextFieldValorRestante.setForeground(new java.awt.Color(51, 51, 51));
        jTextFieldValorRestante.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 10, true));
        jTextFieldValorRestante.setMinimumSize(new java.awt.Dimension(16, 60));
        jTextFieldValorRestante.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTextFieldValorRestanteMouseClicked(evt);
            }
        });
        ...
        jLabel4.setText("Valor que Resta:");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jTextFieldPagoInput, javax.swing.GroupLayout.PREFERRED_SIZE, 139, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(54, 54, 54)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel3)
                    .addComponent(jTextFieldValorParcial, javax.swing.GroupLayout.PREFERRED_SIZE, 139, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(53, 53, 53)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel4)
                    .addComponent(jTextFieldValorRestante, javax.swing.GroupLayout.PREFERRED_SIZE, 139, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(jLabel4)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextFieldValorRestante, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(jLabel3)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextFieldValorParcial, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(jLabel10)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jTextFieldCodigoP.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(25, 25, 25)
                .addComponent(jButtonPagar, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    public void somaProduto(){
        ...
        conecta.executaSQL("select * from parcela_compra WHERE id_parc_compra="+cod_parcela);
        ...
        try {
            ...
            jTextFieldValorRestante.setText(String.valueOf(df.format(total).replace(",", ".")));
        } catch (SQLException ex) {
    ...
    private void jButtonPagarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPagarActionPerformed
        ...
        String message = "Desenja finalizar o Pagamento ?";
        String title = "Finalizar Pagamento";
        ...
        mod.setValor_parcial(valorParcialPago);       
        mod.setValor_resta(restante);
        mod.setPago(Float.parseFloat(jTextFieldPagoInput.getText().replace(",", ".")));
        //mod.setDataatual(sdf.format(atual));
        mod.setIdCaixa(idCaixa);
        mod.setCodCompra(cod_venda);
        
        control.BaixarParcela(mod);
        FrmSelecionaFornecedor c = new FrmSelecionaFornecedor();
        c.setVisible(true);
        dispose();
        
        }else{
        
         JOptionPane.showMessageDialog(null,"Pagamento da Parcela Cancelado");
    ...
    public void limparCampos(){
     ...
     jTextFieldValorParcial.setText("");
     jTextFieldValorRestante.setText("");
    ...
    private void jTextFieldValorParcialMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTextFieldValorParcialMousePressed
         
    }//GEN-LAST:event_jTextFieldValorParcialMousePressed

    private void jTextFieldValorRestanteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTextFieldValorRestanteMouseClicked
       
    }//GEN-LAST:event_jTextFieldValorRestanteMouseClicked
    ...
    private void jButtonValorPagoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonValorPagoActionPerformed
        ...
        valorParcialPago = Float.parseFloat(jTextFieldValorParcial.getText().replace(",", ".")) + Float.parseFloat(jTextFieldPagoInput.getText().replace(",", "."));
       
        jTextFieldValorParcial.setText(String.valueOf(df.format(valorParcialPago)).replace(".", ","));
        restante = Float.parseFloat(jTextFieldValorParcela.getText().replace(",", ".")) - valorParcialPago;
        
        jTextFieldValorRestante.setText(String.valueOf(df.format(restante)).replace(".", ","));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmBaixaParcelaCompra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmBaixaParcelaCompra().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField jTextFieldValorParcial;
