...
public class FrmBaixaParcela extends javax.swing.JFrame {
    ...
    Date dataVencimento;
    public FrmBaixaParcela(int cod) {
        initComponents();
        setIcon();
        valorAction();
        pagarAction();
        ...
        conecta.executaSQL("select * from parcela_venda inner join clientes on parcela_venda.id_cliente = clientes.id_cliente where id_parc_venda="+cod);
        ...
        try {
            ...
            cliente = conecta.rs.getString("nome_cliente");
            ...
            Logger.getLogger(FrmBaixaParcela.class.getName()).log(Level.SEVERE, null, ex);
        }finally{
    ...
    private void initComponents() {
        ...
        jTextFieldValorParcial.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        ...
        jTextFieldValorRestante.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
    ...
    private void jButtonPagarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPagarActionPerformed
        ...
        FrmSelecionaCliente c = new FrmSelecionaCliente();
        c.setVisible(true);
        dispose();
