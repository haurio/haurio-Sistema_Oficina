 ...
 * @author cyro
 */
public class RelatorioVendasDatas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Relatório de Vendas Diárias");
        ...
        jLabel.setText("Vendas realizadas :");
    ...
    public void pesquisarVendas(){
        ...
        dataPesquisa2 = LocalDate.of(Integer.parseInt(dataFormatada2[2]), Integer.parseInt(dataFormatada2[1]),Integer.parseInt(dataFormatada2[0]));
            ...
            preencherTabelaVendasVista("select * from venda where data_venda between '"+dataPesquisa1+"' and '"+dataPesquisa2+"'");
            somaProduto();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
            ...
            public void run(){
              ...
              parc.VendasDatas(dataPesquisa1, dataPesquisa2);
              jLabelCarregando.setVisible(false);
    ...
    public void preencherTabelaVendasVista(String SQL){
        ...
        String[] Colunas = new String[]{"Código Venda","Caixa","Valor da Venda","Vendedor","Data da Venda","Pagamento"};
        conecta.conexao();
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conecta.rs.getInt("id_venda"),conecta.rs.getInt("id_caixa"),  df.format(valorVenda), conecta.rs.getString("vendedor"), format.format(data), conecta.rs.getString("tipo_pagamento")});
        ...
        tabelaVendasFeitas.getColumnModel().getColumn(4).setPreferredWidth(240);
        tabelaVendasFeitas.getColumnModel().getColumn(4).setResizable(false);
        tabelaVendasFeitas.getColumnModel().getColumn(5).setPreferredWidth(240);
    ...
    public void somaProduto(){
        ...
        vista = 0;
        conecta.conexao();
        conecta.executaSQL("select * from venda where data_venda between '"+dataPesquisa1+"' and '"+dataPesquisa2+"'");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RelatorioVendasDatas().setVisible(true);
            }
        });
    }
