 ...
 * @author cyro
 */
public class FrmSelecionaClienteVenda extends javax.swing.JFrame {
    ...
    public FrmSelecionaClienteVenda() {
        initComponents();
    ...
    FrmSelecionaClienteVenda(JTextField jTextFieldProduto) {
        initComponents();
        jTextFieldPesquisar.requestFocus();
        Sair();
        setIcon();
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jButtonSair, javax.swing.GroupLayout.DEFAULT_SIZE, 32, Short.MAX_VALUE)
    ...
    private void jTextFieldPesquisarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldPesquisarKeyReleased
        conecta.conexao();
            try {
                ...
                conecta.executaSQL("select id_cliente ,nome_cliente ,apelido, cpf_cliente, rg_cliente from clientes where nome_cliente like '"+jTextFieldPesquisar.getText()+"%' order by nome_cliente asc");
                conecta.rs.first();
    ...
    private void jButtonSairActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSairActionPerformed
        ...
        public void preencherTabela(){
            ...
            String[] Colunas = new String[]{"Codigo Cliente","Nome Cliente", "Apelido", "CPF","RG"};
            conecta.conexao();
            conecta.executaSQL("select id_cliente ,nome_cliente ,apelido, cpf_cliente, rg_cliente from clientes where nome_cliente like '"+jTextFieldPesquisar.getText()+"%' order by nome_cliente asc");
            ...
            try {
                ...
                do {
                    ...
                    dados.add(new Object[]{conecta.rs.getInt("id_cliente"), conecta.rs.getString("nome_cliente"), conecta.rs.getString("apelido"), conecta.rs.getString("cpf_cliente"),conecta.rs.getString("rg_cliente"),});
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSelecionaClienteVenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmSelecionaClienteVenda().setVisible(true);
            }
        });
    }
