 ...
 * @author cyro
 */
public class RelatorioVendaMes extends javax.swing.JFrame {
    ...
    public RelatorioVendaMes() {
        ...
        conecta.conexao();
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null,"Não há vendas para essa data");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelatorioVendaMes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
